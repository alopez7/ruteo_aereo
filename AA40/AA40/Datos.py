...
#numero de pedidos
pedidos=45
num_nodos = 90 #Cambie esto del codigo de FD
...
file = open("I_distancias_AA40_Rec.txt","w")
...
file = open("I_distancias_AA40_Rec.txt", "r")
tviaje={}
costos={}
i=0
j=0
...
#PLANIFICACION BASE
PB = {
    1: [101,9,54,12,57,14,59,18,63,39,84,32,77,21,66,911],
    2: [102,31,11,76,56,34,79,28,73,15,60,7,52,2,47,912],
    3: [103,40,85,3,48,8,53,4,49,37,82,913],
    4: [104,24,69,36,81,23,68,22,67,19,64,914],
    5: [105,35,80,26,71,915],
    6: [106,16,61,10,55,1,46,13,58,25,70,38,83,20,65,33,78,916],
    7: [107,17,62,30,75,5,50,6,51,27,29,74,72,917]   
}
