...
file = open("I_distancias_AA50_PB.txt","w")
...
file = open("I_distancias_AA50_PB.txt", "r")
tviaje={}
costos={}
i=0
j=0
...
for i in range(num_nodos+1,num_nodos+1+len(aviones)):
    listmacronodos[i]=[i] 

for i in range(1011,1018):
    listmacronodos[i]=[i]
